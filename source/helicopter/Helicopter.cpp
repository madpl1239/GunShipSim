										 ...
										 float altitudeAboveGroundMeters)
{
	...
	m_y = y;
	m_z = z;
	m_altitudeAboveGround = altitudeAboveGroundMeters;
	m_authoritativeYawDegrees = yawDegrees;
	m_authoritativePitchDegrees = pitchDegrees;
	m_authoritativeRollDegrees = rollDegrees;
	m_authoritativeSpeed = speedMetersPerSecond;
	m_authoritativeVerticalSpeed = verticalSpeedMetersPerSecond;
	m_hasAuthoritativeOverride = true;
	m_flightModel.setYawDegrees(yawDegrees);
}
...
{
	return m_hasAuthoritativeOverride ? m_authoritativePitchDegrees : m_flightModel.getPitchDegrees();
}
